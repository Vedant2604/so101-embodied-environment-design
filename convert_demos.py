"""Convert demos/pick/ep*/ into a LeRobotDataset at 320x240."""
import glob, os
import cv2, numpy as np
from lerobot.datasets.lerobot_dataset import LeRobotDataset

REPO_ID = "Ved4nt/so101_pick2"
SRC, FPS = "demos/pick2", 30
W, H = 320, 240
...
features = {
    ...
    "observation.images.wrist": {"dtype": "image", "shape": (H, W, 3),
                                 "names": ["height", "width", "channels"]},
    "observation.images.scene": {"dtype": "image", "shape": (H, W, 3),
                                 "names": ["height", "width", "channels"]},
}
...
for d in sorted(glob.glob(os.path.join(SRC, "ep*"))):
